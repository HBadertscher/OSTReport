...
% Load Colors
\usepackage{xcolor}
% TODO: create package for OST colors
...
\renewcommand{\@makechapterhead}[1]{%
    ...
    \end{minipage}%
    \quad%
    {\fontsize{60pt}{3em}\selectfont\sffamily\textbf{\textcolor{black}{\thechapter}}}%
    \vskip 5\p@%
    \noindent\makebox[\dimexpr\textwidth-2em][l]{\textcolor{black}{\rule{\dimexpr\paperwidth-\oddsidemargin-\hoffset-1in}{0.7pt}}}%
    \vskip 25\p@%
    \normalfont\normalsize%
}
